...
public interface IRestMultiplePrimaryKeys {
    // Delete all data from a tables given its primary key
    boolean delete(Map<String, Object> remove, Map<String, Object> primary, Map<String, Object> argv);

    // Get tables columns given in argv (usually an array) and place them into our array
    boolean get(Map<String, Object> returnData, Map<String, Object> primary, Map<String, Object> argv);

    // Add an associative array Column => value
    Object post(Map<String, Object> post) throws PublicAlert;

    // true on success false on failure
    boolean put(Map<String, Object> returnUpdated, Map<String, Object> primary, Map<String, Object> argv);
}